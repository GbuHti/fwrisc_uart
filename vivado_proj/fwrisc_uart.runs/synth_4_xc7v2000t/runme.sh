...
HD_PWD='D:/Project/16_proj_fwisc_uart/vivado_proj/fwrisc_uart.runs/synth_4_xc7v2000t'
cd "$HD_PWD"
...
EAStep vivado -log fwrisc_uart_wraper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fwrisc_uart_wraper.tcl
