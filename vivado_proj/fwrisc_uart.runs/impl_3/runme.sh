...
HD_PWD='D:/Project/16_proj_fwisc_uart/vivado_proj/fwrisc_uart.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log fwrisc_uart_wraper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fwrisc_uart_wraper.tcl -notrace
